...
extern void usb_first_enable_store_flag(void);
...
DESCRIPTOR_ATTR(bDeviceClass, "%2x\n")
DESCRIPTOR_ATTR(bDeviceSubClass, "%2x\n")
DESCRIPTOR_ATTR(bDeviceProtocol, "%2x\n")
